...
@SupportedAnnotationTypes("org.example.annotation.JeongEntity")
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (final Element element : roundEnv.getElementsAnnotatedWith(JeongGetter.class)) {
            ...
            if(element.getKind() != ElementKind.CLASS){
                processingEnv.getMessager().printMessage(Diagnostic.Kind.ERROR, "@JeongEntity annotation cant be used on" + element.getSimpleName());
            }else{
                processingEnv.getMessager().printMessage(Diagnostic.Kind.NOTE, "@JeongEntity annotation Processing " + element.getSimpleName());
